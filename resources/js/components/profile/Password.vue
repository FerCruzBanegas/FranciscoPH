    ...
    <div class="row justify-content-md-center">
      <div class="col-md-9 col-xl-7">
        <div class="card-header px-0 mt-2 bg-transparent clearfix">
          <h4 class="float-left pt-2">Editar Contraseña</h4>
          ...
          <form class="form-horizontal">
            <div class="form-group row justify-content-md-center">
              ...
              <div class="col-md-9">
                ...
                <small class="form-text text-muted">Debe proporcionar su contraseña actual para poder cambiarla.</small>
            ...
            <div class="form-group row justify-content-md-center">
              <label class="col-md-3">Confirmación de Contraseña</label>
              <div class="col-md-9">
    ...
    updatePasswordAuthUser () {
      if (!this.submiting) {
        ...
        .then(response => {
          ...
          this.$toasted.global.error('Contraseña Actualizada!');
        })
        .catch(error => {
