        ...
        <div class="card-body px-0">
          <form class="form-horizontal" v-if="!loading">
            <div class="form-group row justify-content-md-center">
              ...
              <div class="col-md-9">
                <small class="form-text text-muted mb-3">Puede cambiar su avatar aquí o eliminar el avatar actual</small>
            ...
            <div class="form-group row justify-content-md-center">
              ...
              <div class="col-md-9">
                ...
                <small class="form-text text-muted">Ingrese su nombre para que las personas puedan reconocerlo.</small>
            ...
            <div class="form-group row justify-content-md-center">
              ...
              <div class="col-md-9">
                ...
                <small class="form-text text-muted">Este correo electrónico se mostrará en su perfil público.</small>
